...
FINALIZE_INSTRUCTIONS = (
    ...
    "You are the dedicated finalize node: unlike the Step 7 group chat Coordinator "
    "(the manager, which returned a structured routing decision and couldn't own "
    "tools/skills), you own the final deliverable "
    "and its safety:\n"
